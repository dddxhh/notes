...
// Forked from wa-sqlite/src/examples/IDBBatchAtomicVFS.js with bug fixes.
import * as VFS from "wa-sqlite/src/VFS.js";
import { WebLocksExclusive as WebLocks } from "wa-sqlite/src/examples/WebLocks.js";
import { IDBContext } from "wa-sqlite/src/examples/IDBContext.js";
  ...
  xOpen(name, fileId, flags, pOutFlags) {
    return this.handleAsync(async () => {
      ...
      try {
        ...
        // FIX: Only add to map if block0 was successfully read/created.
        // If the file doesn't exist and SQLITE_OPEN_CREATE is not set,
        // return SQLITE_CANTOPEN without adding a stale entry to the map.
        if (!file.block0) {
