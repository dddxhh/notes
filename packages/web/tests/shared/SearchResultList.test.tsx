...
describe("SearchResultList", () => {
  ...
  it("renders 搜索中... when loading is true", () => {
    render(<SearchResultList result={null} loading={true} onSelectNote={mockOnSelectNote} onLoadMore={mockOnLoadMore} />);
    expect(screen.getByText("搜索中...")).toBeTruthy();
  });

  it("renders 暂无结果 when result is null and not loading", () => {
    render(<SearchResultList result={null} loading={false} onSelectNote={mockOnSelectNote} onLoadMore={mockOnLoadMore} />);
    expect(screen.getByText("暂无结果")).toBeTruthy();
  });

  it("renders list of search result items", () => {
    render(<SearchResultList result={mockResult} loading={false} onSelectNote={mockOnSelectNote} onLoadMore={mockOnLoadMore} />);
  ...
  it("加载更多 button appears when hasMore is true", () => {
    ...
    render(<SearchResultList result={resultWithMore} loading={false} onSelectNote={mockOnSelectNote} onLoadMore={mockOnLoadMore} />);
