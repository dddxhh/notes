...
vi.mock("../../src/stores", () => ({
  useFoldersStore: (selector?: any) => selector ? selector({ folders: mockFolders }) : { folders: mockFolders },
  useNotesStore: vi.fn(),
  useUIStore: vi.fn(),
  useTagsStore: vi.fn(),
...
describe("MoveNoteDialog", () => {
  ...
  it("renders folder list when open", () => {
    render(<MoveNoteDialog open={true} onOpenChange={mockOnOpenChange} noteId="n1" currentFolderId="f1" onMove={mockOnMove} />);
    expect(screen.getByText("Work")).toBeTruthy();
    expect(screen.getByText("Personal")).toBeTruthy();
  });

  it("does not render when closed", () => {
    render(<MoveNoteDialog open={false} onOpenChange={mockOnOpenChange} noteId="n1" currentFolderId="f1" onMove={mockOnMove} />);
